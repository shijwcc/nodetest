...
router.post('/test1',userControlle.postUser);    //post请求相同，调用postUser方法
router.post('/getTableData',userControlle.test2);    //post请求相同，调用postUser方法
router.post('/delTableData',userControlle.test3);    //post请求相同，调用postUser方法
//这边
